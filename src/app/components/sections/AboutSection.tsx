...
return ( <section
   id="about"
   className="relative scroll-mt-24 overflow-hidden bg-white py-24 sm:py-28 lg:py-36"
 >
{/* =====================================================
BACKGROUND
===================================================== */}
        ...
        <div className="relative">
          ...
          <div className="space-y-5 text-[15px] leading-8 text-slate-600 sm:text-base">
            <p>
              ...
              technology should not make business more complicated. It
              should make businesses more capable.
            </p>
